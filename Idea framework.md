 ...
 ###Organization: Oil Limited India.

 ###Company: Oil Limited India.
 ...
 This idea framework is designed for on-site work which contributes in easy reporting, schedule update. It also helps in analysing actual durations, recurring delay causes and discipline-wise productivity.

 The main idea is to create a software which uses intelligent data capturing to update schedule that connects on-site real progress to planned planner.



 ##IDEA EXPLANATION

 The idea is to create a layered software which collects all the files present in any format(text, pdf, files, documents, etc), curate it in different domain, and update it in the schedule, keeping the history for analysing the bottleneck of the project.

 The user can give the data to the software through voice in real time of the work details which the ai agent will curate and add to the DPR/actual schedule.

 The system should provide curated data, updated in real progress schedule in real time by maintaing a growing queryable work hsitory.